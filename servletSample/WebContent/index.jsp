...
<body>
	...
	<!--参考にできそうなURL↓
		...
		「今日」とかを囲みたかったら、今日をh1ごとdivで囲んでcssのwakuを使う。
	-->
	<!--
	...
	<div id="bottom1">
		<!-- 履歴ボタン -->
		<input type="button" onclick="location.href='http://localhost:8080/servletSample/log.jsp'" value="履歴" style="width:100px; height:50px" >&nbsp;&nbsp;&nbsp;
		<!-- 追加ボタン -->
		<input type="button" onclick="location.href='Sample5.html'" value="追加" style="width:100px; height:50px" >
	</div>
